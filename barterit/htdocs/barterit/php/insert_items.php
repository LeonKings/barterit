...
$sqlinsert="INSERT INTO `tbl_items`(`user_id`,`item_name`, `item_desc`, `item_qty`, `item_lat`, `item_long`, `item_state`, `item_locality`)VALUES('$userid','$item_name','$item_desc','$item_qty','$latitude','$longitude','$state','$locality')";
